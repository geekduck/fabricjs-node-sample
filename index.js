var fs = require('fs'),
    ...
    canvas = fabric.createCanvasForNode(2000, 1000);

var font = new canvas.Font('cFont', '/System/Library/Fonts/ヒラギノ角ゴシック\ W3.ttc');
...
var out = fs.createWriteStream(__dirname + '/out_' + new Date().getTime() + '.png');
